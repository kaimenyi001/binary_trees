...
/**
 * check_sub_tree_Left - check nodes are smaller than the root
 * @node: node in the tree to verify condition
 * @max: value to compare
 * Return: 1, if smaller or equal else 0, if not
 */
...
/**
 * check_sub_tree_Right - check if nodes are bigger than the root
 * @node: node in the tree to verify condition
 * @min: value to compare
 * Return: 1, if bigger or equal else 0, if not
 */
